...
function fmtTrace(t: AiMoveTrace): string {
  const lines: string[] = [
    ...
    '  moverMaterialValue: ' + num(t.moverMaterialValue),
    '  hiddenRecaptureMaterialLoss: ' + num(t.hiddenRecaptureMaterialLoss),
    '  unsafeHiddenRecaptureExchange: ' + bool(t.unsafeHiddenRecaptureExchange),
    '  unsafeHiddenRecaptureExchangePenalty: ' + num(t.unsafeHiddenRecaptureExchangePenalty),
    '  hiddenMoverExpectedValue: ' + num(t.hiddenMoverExpectedValue),
    '  hiddenMoverLowValueLoss: ' + num(t.hiddenMoverLowValueLoss),
    '  hiddenMoverLowValueCapture: ' + bool(t.hiddenMoverLowValueCapture),
    '  hiddenMoverLowValueCapturePenalty: ' + num(t.hiddenMoverLowValueCapturePenalty),
    '  priorityTier: ' + num(t.priorityTier),
    '  priorityTierLabel: ' + (t.priorityTierLabel ?? '-'),
    '  prioritySubRank: ' + (t.prioritySubRank ?? '-'),
    '  bestAvailablePriorityTier: ' + num(t.bestAvailablePriorityTier),
    '  filteredByHigherPriorityTier: ' + bool(t.filteredByHigherPriorityTier),
    '  materialCaptureRank: ' + (t.materialCaptureRank ?? '-'),
    ...
    '  pawnSoldierSacrificeHasTacticalJustification: ' + bool(t.pawnSoldierSacrificeHasTacticalJustification),
    ...
    '  pawnSoldierWalksIntoPawnAttackPenalty: ' + num(t.pawnSoldierWalksIntoPawnAttackPenalty),
    '  pawnSoldierDevelopmentScore: ' + num(t.pawnSoldierDevelopmentScore),
  ...
  '  repetitionCount: ' + num(t.repetitionCount),
    ...
    '  edgeRookThreatSide: ' + (t.edgeRookThreatSide ?? '-'),
    '  threatenedPawnLineCol: ' + num(t.threatenedPawnLineCol),
    '  sameSideEdgeRookHorseGuard: ' + bool(t.sameSideEdgeRookHorseGuard),
    '  directPawnLineRookThreat: ' + bool(t.directPawnLineRookThreat),
